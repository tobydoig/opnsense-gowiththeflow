INSERT INTO live_sessions (proto, local_ip, local_port, peer_ip, peer_port, peer_is_local, peer_hostname, hostname_source, state, first_seen, last_seen, last_activity, bytes_in, bytes_out, pkts_in, pkts_out)
VALUES ('tcp', '10.0.0.9', 52069, '172.66.147.243', 443, 0, 'example.com', 'dns', 'ESTABLISHED', strftime('%s','now')-90, strftime('%s','now'), strftime('%s','now'), 45000, 3200, 40, 22);
